 ...
 * specified {@link OnInviteListFragmentInteractionListener}.
...
public class MyInviteRecyclerViewAdapter extends RecyclerView.Adapter<MyInviteRecyclerViewAdapter.ViewHolder> {
    ...
    private final InviteFragment.OnInviteListFragmentInteractionListener mListener;

    public MyInviteRecyclerViewAdapter(List<DummyItem> items, OnInviteListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_invite, parent, false);
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onInviteListFragmentInteraction(holder.mItem);
                }
            }
        });
    }
